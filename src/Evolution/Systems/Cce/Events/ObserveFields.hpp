...
class ObserveFields : public Event {
 ...
 public:
  ...
  using compute_tags_for_observation_box = tmpl::list<
      ...
      Tags::DyCompute<Tags::Psi3Residue>, Tags::DyCompute<Tags::ExpMinus2Beta>,
      ...
      Tags::Psi3ResidueCompute, Tags::NewmanPenroseDCompute<Tags::Psi3Residue>,
